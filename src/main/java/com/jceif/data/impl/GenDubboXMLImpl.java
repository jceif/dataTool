...
import com.jceif.data.service.GenDubboXMLService;
...
public class GenDubboXMLImpl implements GenDubboXMLService {
	...
	public String geneCustomerXML(String schemaName, String target)
		...
		// interface="com.minxindai.callcenter.remote.com.jceif.data.service.capital.RemoteCapitalService"
		// />
		// <dubbo:reference id="remoteCustomerService"
		// interface="com.minxindai.callcenter.remote.com.jceif.data.service.customer.RemoteCustomerService"/>
		// <dubbo:reference id="remoteCustomerHisService"
		// interface="com.minxindai.callcenter.remote.com.jceif.data.service.customerhis.RemoteCustomerHisService"/>
...
//		    <dubbo:protocol name="dubbo" port="20880"/>
	...
	public String dubboService(String tableName, String target) {
		...
		// class="com.minxindai.callcenter.remote.com.jceif.data.service.customerhis.com.jceif.data.impl.RemoteCustomerHisServiceImpl"/>
		// <dubbo:com.jceif.data.service ref="remoteCustomerHisService"
		// interface="com.minxindai.callcenter.remote.com.jceif.data.service.customerhis.RemoteCustomerHisService"/>
		sb.append(LINE + "<bean id=\"" + paramName + "Service\"");

		sb.append(" class=\"" + servicePath + paramName.toLowerCase()
				+ ".com.jceif.data.impl." + className + "ServiceImpl\"/>");
		sb.append(LINE+"<dubbo:com.jceif.data.service ref=\""+paramName+"Service\"");
		sb.append(" interface=\""+servicePath+paramName.toLowerCase()+"."+className+"Service\"/>");
