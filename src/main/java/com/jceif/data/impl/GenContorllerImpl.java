...
import com.jceif.data.service.GenContorllerService;
...
public class GenContorllerImpl implements GenContorllerService {
	...
	public String geneContorller(String tableName, String schemaName,String sqlType)
			throws Exception {
	...
	private String getImport(String tableName) {
		...
		sb.append(LINE
				+ "import com.minxindai.dc.com.jceif.data.controller.oracle.OneController;");

		sb.append(LINE + "import com.minxindai.com.jceif.data.common.util.GUIDUtil;");
		sb
				.append(LINE
						+ "import com.minxindai.dc.com.jceif.data.model.imdatarecord.OracleImDataRecord;");

		sb.append(LINE + "import java.text.ParseException;");
		sb
				.append(LINE
						+ "import com.minxindai.dc.com.jceif.data.service.oracle.imdatarecord.OracleImDataRecordService;");
